...
![setup.png](bolzmann_machine/setup.png)
...
![abc.png](bolzmann_machine/abc.png)
...
![model.png](bolzmann_machine/model.png)
...
![weights.png](bolzmann_machine/weights.png)
...
![calc.png](bolzmann_machine/calc.png)
...
ボルツマンマシンの学習とは、与えられた可視層の情報を「一番もっともらしく」表現できるモデルを探すこと、すなわち最尤推定です。一般のボルツマンマシンの学習は極めて大変ですが、制限ボルツマンマシンの場合は効率の良い学習方法が知られています。そのあたりは「制限ボルツマンマシンの基礎 ～学習編～」で触れます。

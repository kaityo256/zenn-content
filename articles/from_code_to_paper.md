...
データの公開には、東京大学物性研究所の[ISSP データリポジトリ](https://mdcl.issp.u-tokyo.ac.jp/scc/guide/application_proposal/issp-datarepo)を利用させていただいています。また、本論文の査読者には、迅速かつていねいな査読レポートを書いていただき、とても助かりました。合わせて感謝いたします。なお、論文やデータに間違いがあれば、それは筆者によるものです。
